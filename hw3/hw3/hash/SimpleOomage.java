...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        SimpleOomage tester = (SimpleOomage) o;
        if (this.red == tester.red && this.blue == tester.blue && this.green == tester.green) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            return (red / 5) * (int) Math.pow(256, 2) + (green / 5) * 256 + blue / 5;
        }
    }
